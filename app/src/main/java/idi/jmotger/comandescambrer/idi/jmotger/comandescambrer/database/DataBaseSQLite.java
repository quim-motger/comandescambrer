...
public class DataBaseSQLite extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS LINE_ORDER (ORDER_ID INTEGER, PRODUCT_NAME TEXT, QTT INTEGER, TOTAL REAL, PRIMARY KEY (ORDER_ID, PRODUCT_NAME), FOREIGN KEY (ORDER_ID) REFERENCES ORDERS (ORDER_ID), FOREIGN KEY (PRODUCT_NAME) REFERENCES PRODUCT (NAME));");
